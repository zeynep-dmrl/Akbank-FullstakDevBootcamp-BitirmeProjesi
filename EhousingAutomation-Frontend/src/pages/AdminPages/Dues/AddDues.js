...
function AddDues() {
    ...
    const handleSubmit = (event) => {
        ...
        const resdata = {
            ...
            "duesDesc": formValue.duesDesc,
        };
        axios.post('http://localhost:5036/api/Bill', resdata)
            .then(response => {
                setformValue({ duesId: response.data.duesId });
                <SuccesAlertWidget />
    ...
    return (
        <>
            <div className='form-container'>
                <h1 className='formTitle'>Aidat Ekle</h1>
                <form className='addFormNear' onSubmit={handleSubmit}>
                    ...
                    <div className='formItem'>
                        ...
                        <input type="text" name='duesDesc' value={formValue.duesDesc} onChange={handleChange} />
                    </div>
                    <br />
